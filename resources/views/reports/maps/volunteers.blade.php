<x-layouts.admin :title="$title">
    ...
    <x-slot name="subHeader">Bubble size = volunteer count · Color = activity intensity</x-slot>

    <div class="p-4 md:p-6">

        {{-- Level toggle --}}
        <div class="flex gap-2 mb-4">
            <a href="{{ route('reports.maps.volunteers.branches') }}"
            ...
            <a href="{{ route('reports.maps.volunteers.divisions') }}"
               class="px-4 py-2 rounded text-sm font-medium
                      {{ $level === 'division'
                           ? 'bg-indigo-600 text-white'
                           : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
        ...
        @if (! $hasHeat)
            <p class="mb-3 text-sm text-gray-600 bg-gray-50 border border-gray-200 rounded px-3 py-2">
                ...
                Activity heat not yet computed; run <code>heat:recalculate</code>.
                Bubbles shown in neutral color.
            </p>
        @endif
