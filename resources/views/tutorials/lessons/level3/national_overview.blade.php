                ...
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <div class="grid grid-cols-1 gap-4 text-left mb-4">
                        <div class="rounded-xl bg-gray-50 border border-gray-100 p-5" data-reveal>
                            ...
                            <p class="text-sm text-gray-600">Controls how long a volunteer can go without activity before becoming Dormant. Supporting members with a paid fee are handled differently — they become Dormant when their payment expires, not from this setting.</p>
                        </div>
                        <div class="rounded-xl bg-gray-50 border border-gray-100 p-5" data-reveal>
