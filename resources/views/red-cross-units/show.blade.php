        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden mb-8">
                ...
                <div class="border-t px-6 pb-4">
                    ...
                    <div class="mt-3">
                        {{-- Same rule as the RCU certificates list: an active unit
                             with a current (paid) annual fee. --}}
                        <a
                            @if(! $redCrossUnit->is_active || ! $redCrossUnit->isPaid())
                                href="#"
                                class="btn-certificates opacity-40 pointer-events-none"
                                aria-disabled="true"
                                tabindex="-1"
                            @else
                                href="{{ route('red-cross-units.certificates.index', ['search' => $redCrossUnit->id]) }}"
